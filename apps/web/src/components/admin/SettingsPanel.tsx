...
export const SettingsPanel: React.FC = () => {
  ...
  const saveSettings = async () => {
    setIsLoading(true);
    try {
      // Settings will be persisted via the backend API once implemented.
      // For now, settings are stored in component state only.
      toast({
        title: 'Settings saved locally',
        description: 'Connect the backend to persist settings across sessions.',
      });
    } finally {
      setIsLoading(false);
    }
